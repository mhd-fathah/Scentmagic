...
router.get('/orders/cancel/:orderId',auth.checkBlocked,auth.checkSession , orderController.cancelOrder);

router.get('/orders/return/:orderId',auth.checkBlocked,auth.checkSession , orderController.returnOrder);
